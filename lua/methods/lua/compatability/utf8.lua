-- utf8.lua - BizHawk & DeSmuME compatible UTF-8 helper

local bit    = bit    -- expect environment to provide 'bit'
local error  = error
local ipairs = ipairs
local string = string
local table  = table
...
-- Expose as global 'utf8' (matches typical usage) and support both require/dofile styles
_G.utf8 = utf8

-- If loaded via require, return the table
return utf8
